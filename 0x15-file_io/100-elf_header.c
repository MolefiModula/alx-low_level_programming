 ...
 * @e_ident: arrays pointer containing elf magic numbers
 *
 ...
 * @e_ident: Arrays pointer containing elf class
 */
void print_class(unsigned char *e_ident)
{
	printf(" Class:			");
 ...
 * @e_ident: Arrays pointer containing the elf class
 */
 ...
 * @e_ident: Arrays pointer containing elf version
 */
void print_version(unsigned char *e_ident)
{
 ...
 * @e_ident: Arrays pointer containing the elf version
 */
void print_osabi(unsigned char *e_ident)
{
	printf(" OS/ABI:			");
 ...
 * @e_ident: Arrays pointer containing the elf abi version
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * main - displays info contained in header
 * @argc: num of argumennts
 * @argv: Arrays pointer to arguments
 *
 * Description: if file not elf or funtion fails - exit code 98
 */
